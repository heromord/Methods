...
class FlightsArr:
    def __init__(self, id, name, date, time, number, hash, hardhash):
        """
    ...
    def __str__(self):
        ...
        :rtype: str
        """
        return str(self.id) + " " + self.name + " " + str(self.date) + " " + str(self.time) + " " + str(self.number) + " " + str(self.hash) + " " + str(self.hardhash)
